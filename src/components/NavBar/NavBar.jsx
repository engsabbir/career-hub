...
const NavBar = () => {
    ...
    return (
        <div className="sticky top-0 shadow-lg mt-0 z-10">
            <div className="navbar bg-base-100 max-w-screen-xl mx-auto">
                <div className="navbar-start ">
                    ...
                    <Link to='/' className="hover:text-blue-700 normal-case text-xl md:text-2xl lg:text-3xl font-bold">CareerHub</Link>
                </div>
